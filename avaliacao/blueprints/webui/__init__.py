...
from .views import cadastro_turma, cadastro_usuario, edita_avaliacao, home, inserir_notas, cadastro_avaliacao, tabela_avaliacao_turma, visualiza_avaliacao, visualiza_media, login, visualiza_boletim, visualiza_usuarios
