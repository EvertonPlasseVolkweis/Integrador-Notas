...
from .views import cadastro_usuario, home, inserir_notas, cadastro_avaliacao, tabela_avaliacao_turma, visualiza_avaliacao, visualiza_media, login, visualiza_boletim, visualiza_usuarios
