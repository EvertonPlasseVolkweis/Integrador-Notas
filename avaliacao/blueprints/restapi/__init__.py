...
from .resources import BuscarUsuario, CadastroTurma, CadastroUsuario, DeleteAvaliacao, EditAvaliacao, EditUsuario, LogoutResource, NotaAvaliaResource, UsuariosResource, CadastroAvaliacaoResource
